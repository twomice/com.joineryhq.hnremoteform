 ...
 */
class CRM_Hnremoteform_Upgrader_Base {

  /**
   * @var CRM_Hnremoteform_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Hnremoteform_Upgrader(
        'com.joineryhq.hnremoteform',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Hnremoteform_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Hnremoteform_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
